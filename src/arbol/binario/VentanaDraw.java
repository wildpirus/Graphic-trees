 ...
 * @author wildg
 */
public class VentanaDraw extends javax.swing.JFrame {

    /**
     * Creates new form VentanaDraw
     */
    AVL Arbol;
    public VentanaDraw() {
        initComponents();
    ...
    private void repintarArbol() {
        ...
        this.jInternalFrame2.add(Arbol.getdibujo(), BorderLayout.CENTER);
    }
    
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int info = Integer.parseInt(jTextField1.getText());
        //Arbol.insertarNodo(info);
        /**/int  x;
        Arbol.borrarArbol();
        for (int i = 0; i < info; i++) {
            x=(int)(Math.random()*100);
            Arbol.insertarNodo(x);
        }/**/
        complementos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaDraw.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaDraw().setVisible(true);
            }
        });
    }
