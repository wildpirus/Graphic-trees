 ...
 * @author wildg
 */
public class VentanaABB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DrawPanel.setPreferredSize(new java.awt.Dimension(1500, 452));
    ...
    /**
     * Se encarga de pintar todo el árbol.
     ...
     * va a ser dibujado, luego dibuja el árbol teniendo en cuenta las ubicaciones de los nodos 
     * y los subárboles calculadas anteriormente.
     * @param n: Objeto de tipo Nodo <T> que se utiliza como
     ...
     * @param g: Objeto de la clase Graphics que permite realizar el dibujo de las líneas, rectangulos y del 
     *           String de la información que contiene el Nodo.
     * @param puntox: int con la posición en x desde donde se va a dibujar la línea hasta el siguiente hijo.
     * @param puntoy: int con la posición en y desde donde se va a dibujar la línea hasta el siguiente hijo.
     * @param yoffs: int con la altura del FontMetrics.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaABB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaABB().setVisible(true);
            }
        });
    }
